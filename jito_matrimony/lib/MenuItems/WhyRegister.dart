...
class WhyRegister extends StatefulWidget{

  String htmlCont;
  WhyRegister({this.htmlCont});

  @override
  _whyReg createState() => _whyReg();
}

class _whyReg extends State<WhyRegister>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Why Register?', style:TextStyle(color: Colors.white))
